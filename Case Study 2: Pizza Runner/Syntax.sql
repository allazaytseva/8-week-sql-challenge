...
---giving csv values in the pizza_recipes table a separate row---
---when we work with this table, it's important we create a temp table---
SELECT 
  pizza_id,
  UNNEST(STRING_TO_ARRAY(toppings, ',')) AS pizza_toppings
FROM pizza_runner.pizza_recipes;

---sometimes it pays off to trim some empty spaces when for example working with emails, then we would use TRIM function---
---we could also convert the rows back in one row to get the comma separated values again---
